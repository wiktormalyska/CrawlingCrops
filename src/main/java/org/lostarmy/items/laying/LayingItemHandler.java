...
public class LayingItemHandler {
    ...
    public void generateItems(){
        ...
        for (int i = 0; i < numItems; i++) {
            ...
            while (HandlersManager.mapHandler.getCell(x, y) instanceof Wall ||
                    HandlersManager.mapHandler.getCell(x, y) instanceof Tree ||
                    HandlersManager.mapHandler.getCell(x, y) instanceof TrapDor ||
                    HandlersManager.mapHandler.getCell(x, y) instanceof Border) {
